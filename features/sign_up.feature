Feature: Sign up
  ...
  Scenario Outline: Email field validation - invalid case: <case>
    ...
    Examples:
      ...
      | max email length + 1           | 100_characters_loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong_email@testemail.com | Email is invalid or already taken  |
